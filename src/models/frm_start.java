...
public class frm_start extends javax.swing.JFrame {
   ...
   //public static String[] arrayTexto = txt_entrada.getText().indexOf(" ",1);
    ...
    private void initComponents() {
        ...
        pn_background.setBackground(new java.awt.Color(0, 0, 0));
        ...
        lbl_logo.setForeground(new java.awt.Color(204, 204, 204));
        lbl_logo.setText("Manejo de Cadenas");
        pn_background.add(lbl_logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 170, 40));
        ...
        txt_salida.setForeground(new java.awt.Color(153, 153, 153));
        ...
        pn_background.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 450, 880, 140));

        lbl_palaImpar.setForeground(new java.awt.Color(204, 204, 204));
        lbl_palaImpar.setText("Palabras con cantida de caracter impar:");
        pn_background.add(lbl_palaImpar, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 400, -1, -1));
        ...
        lbl_totalpalabras.setForeground(new java.awt.Color(204, 204, 204));
        lbl_totalpalabras.setText("Total de palabras:");
        pn_background.add(lbl_totalpalabras, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 310, -1, -1));

        lbl_primerale.setForeground(new java.awt.Color(204, 204, 204));
        lbl_primerale.setText("Primer letra del texto:");
        pn_background.add(lbl_primerale, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 340, -1, -1));

        lbl_ultimale.setForeground(new java.awt.Color(204, 204, 204));
        lbl_ultimale.setText("Ultima letra del texto:");
        pn_background.add(lbl_ultimale, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 370, -1, -1));

        lbl_letracentral.setForeground(new java.awt.Color(204, 204, 204));
        lbl_letracentral.setText("Letra central del texto: ");
        pn_background.add(lbl_letracentral, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 400, -1, -1));

        lbl_repeticionesA.setForeground(new java.awt.Color(204, 204, 204));
        lbl_repeticionesA.setText("Repeticiones de \"A\", \"a\" y \"á\":");
        pn_background.add(lbl_repeticionesA, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 280, -1, -1));

        lbl_repeticionesE.setForeground(new java.awt.Color(204, 204, 204));
        lbl_repeticionesE.setText("Repeticiones de \"E\",\"e\" y \"é\":");
        pn_background.add(lbl_repeticionesE, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 310, -1, -1));

        lbl_repeticionesI.setForeground(new java.awt.Color(204, 204, 204));
        lbl_repeticionesI.setText("Repeticions de \"I\",\"i\" y \"í\":");
        pn_background.add(lbl_repeticionesI, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 340, -1, -1));

        lbl_repeticionesO.setForeground(new java.awt.Color(204, 204, 204));
        lbl_repeticionesO.setText("Repeticiones de \"O\",\"o\" y \"ó\":");
        pn_background.add(lbl_repeticionesO, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 370, -1, -1));

        lbl_repeticionesU.setForeground(new java.awt.Color(204, 204, 204));
        lbl_repeticionesU.setText("Repeticiones de \"U\",\"u\" y \"ú\":");
        pn_background.add(lbl_repeticionesU, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 400, -1, -1));

        lbl_primerapa.setForeground(new java.awt.Color(204, 204, 204));
        lbl_primerapa.setText("Primera palabra:");
        pn_background.add(lbl_primerapa, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 280, -1, -1));

        lbl_palacentral.setForeground(new java.awt.Color(204, 204, 204));
        lbl_palacentral.setText("Palabra central:");
        pn_background.add(lbl_palacentral, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 310, -1, -1));

        lbl_ultimapa.setForeground(new java.awt.Color(204, 204, 204));
        lbl_ultimapa.setText("Ultima palabra: ");
        pn_background.add(lbl_ultimapa, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 340, -1, -1));

        lbl_palaPar.setForeground(new java.awt.Color(204, 204, 204));
        lbl_palaPar.setText("Palabras con cantida de caracter par:");
        pn_background.add(lbl_palaPar, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 370, -1, -1));

        lbl_longitudtxt1.setForeground(new java.awt.Color(204, 204, 204));
        lbl_longitudtxt1.setText("Longitud del texto: ");
        pn_background.add(lbl_longitudtxt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 280, -1, -1));

        btb_guardar.setBackground(new java.awt.Color(102, 102, 102));
        btb_guardar.setForeground(new java.awt.Color(204, 204, 204));
        ...
        pn_background.add(btb_guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 280, 90, 40));
        ...
        txt_entrada.setForeground(new java.awt.Color(153, 153, 153));
        ...
        pn_background.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 880, 200));

        btb_procesar.setBackground(new java.awt.Color(102, 102, 102));
        btb_procesar.setForeground(new java.awt.Color(204, 204, 204));
        ...
        pn_background.add(btb_procesar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 90, 40));

        lbl_letra_central.setForeground(new java.awt.Color(255, 255, 255));
        lbl_letra_central.setText("0");
        pn_background.add(lbl_letra_central, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 400, -1, -1));

        lbl_longitud.setForeground(new java.awt.Color(255, 255, 255));
        lbl_longitud.setText("0");
        pn_background.add(lbl_longitud, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 280, -1, -1));

        lbl_total_palabras.setForeground(new java.awt.Color(255, 255, 255));
        lbl_total_palabras.setText("0");
        pn_background.add(lbl_total_palabras, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 310, -1, -1));

        lbl_primer_letra.setForeground(new java.awt.Color(255, 255, 255));
        lbl_primer_letra.setText("0");
        pn_background.add(lbl_primer_letra, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 340, -1, -1));

        lbl_ultima_letra.setForeground(new java.awt.Color(255, 255, 255));
        lbl_ultima_letra.setText("0");
        pn_background.add(lbl_ultima_letra, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 370, -1, -1));

        lbl_rep_A.setForeground(new java.awt.Color(255, 255, 255));
        lbl_rep_A.setText("0");
        pn_background.add(lbl_rep_A, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 280, -1, -1));

        lbl_rep_E.setForeground(new java.awt.Color(255, 255, 255));
        lbl_rep_E.setText("0");
        pn_background.add(lbl_rep_E, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 310, -1, -1));

        lbl_rep_I.setForeground(new java.awt.Color(255, 255, 255));
        lbl_rep_I.setText("0");
        pn_background.add(lbl_rep_I, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 340, -1, -1));

        lbl_rep_O.setForeground(new java.awt.Color(255, 255, 255));
        lbl_rep_O.setText("0");
        pn_background.add(lbl_rep_O, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 370, -1, -1));

        lbl_rep_U.setForeground(new java.awt.Color(255, 255, 255));
        lbl_rep_U.setText("0");
        pn_background.add(lbl_rep_U, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 400, -1, -1));

        lbl_primera_palabra.setForeground(new java.awt.Color(255, 255, 255));
        lbl_primera_palabra.setText("0");
        pn_background.add(lbl_primera_palabra, new org.netbeans.lib.awtextra.AbsoluteConstraints(817, 280, 70, -1));

        lbl_palabra_central.setForeground(new java.awt.Color(255, 255, 255));
        lbl_palabra_central.setText("0");
        pn_background.add(lbl_palabra_central, new org.netbeans.lib.awtextra.AbsoluteConstraints(817, 310, 70, -1));

        lbl_ultima_palabra.setForeground(new java.awt.Color(255, 255, 255));
        lbl_ultima_palabra.setText("0");
        pn_background.add(lbl_ultima_palabra, new org.netbeans.lib.awtextra.AbsoluteConstraints(817, 340, 70, -1));

        lbl_cantidad_par.setForeground(new java.awt.Color(255, 255, 255));
        lbl_cantidad_par.setText("0");
        pn_background.add(lbl_cantidad_par, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 370, -1, -1));

        lbl_cantidad_impar.setForeground(new java.awt.Color(255, 255, 255));
        lbl_cantidad_impar.setText("0");
        pn_background.add(lbl_cantidad_impar, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 400, -1, -1));

        btb_revelar.setBackground(new java.awt.Color(102, 102, 102));
        btb_revelar.setForeground(new java.awt.Color(204, 204, 204));
        ...
        pn_background.add(btb_revelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 370, 180, 40));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pn_background, javax.swing.GroupLayout.DEFAULT_SIZE, 922, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(pn_background, javax.swing.GroupLayout.PREFERRED_SIZE, 630, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btb_revelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btb_revelarActionPerformed
        //decodficando idioma murcielago XD
       /* conversion.entrada();
